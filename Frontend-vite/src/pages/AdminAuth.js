    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 flex items-center justify-center px-4">
        <div className="max-w-4xl w-full flex bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="w-1/2 p-8 flex flex-col justify-center">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="relative">
                <input
                  className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-lg focus:border-purple-500 focus:bg-white focus:outline-none transition-all duration-300 placeholder-gray-500"
                  type="email"
              ...
              <button
                className="w-full py-3 mt-6 bg-gradient-to-r from-purple-500 to-purple-600 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                type="submit"
                disabled={loading}
              >
          ...
          <div className="w-1/2 bg-gradient-to-br from-purple-600 to-indigo-600 p-8 flex flex-col justify-center text-white">
            <div className="text-center mb-8">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <button
                className="w-full py-3 mt-6 bg-white text-purple-600 font-semibold rounded-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                type="submit"
                disabled={loading}
              >
            ...
            <div className="mt-8 p-4 bg-white/10 rounded-lg">
              <h4 className="font-semibold mb-2">Admin Privileges:</h4>
